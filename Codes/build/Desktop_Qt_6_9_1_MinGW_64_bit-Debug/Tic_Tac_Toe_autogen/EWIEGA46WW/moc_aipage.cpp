...
template <> constexpr inline auto Aipage::qt_create_metaobjectdata<qt_meta_tag_ZN6AipageE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "Aipage",
        "on_level_ai_currentTextChanged",
        "",
        "arg1",
        "on_turn_box_ai_currentTextChanged",
        "on_back_tomain_ai_clicked",
        "on_level_ai_currentIndexChanged",
        "index",
        "on_start_game_ai_clicked",
        "on_level_ai_activated"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_level_ai_currentTextChanged'
        QtMocHelpers::SlotData<void(const QString &)>(1, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QString, 3 },
        }}),
        // Slot 'on_turn_box_ai_currentTextChanged'
        QtMocHelpers::SlotData<void(const QString &)>(4, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QString, 3 },
        }}),
        // Slot 'on_back_tomain_ai_clicked'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_level_ai_currentIndexChanged'
        QtMocHelpers::SlotData<void(int)>(6, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 7 },
        }}),
        // Slot 'on_start_game_ai_clicked'
        QtMocHelpers::SlotData<void()>(8, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_level_ai_activated'
...
void Aipage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_level_ai_currentTextChanged((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->on_turn_box_ai_currentTextChanged((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->on_back_tomain_ai_clicked(); break;
        case 3: _t->on_level_ai_currentIndexChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 4: _t->on_start_game_ai_clicked(); break;
        case 5: _t->on_level_ai_activated((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
}
